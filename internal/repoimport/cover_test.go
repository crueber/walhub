...
func TestIsPrivateIPShapes(t *testing.T) {
	for _, tc := range []struct {
		...
		{"198.18.0.1", true}, {"198.19.255.254", true}, {"198.20.0.1", false},
		{"192.0.2.1", true}, {"198.51.100.1", true}, {"203.0.113.1", true},
		{"240.0.0.1", true}, {"::", true}, {"2001:db8::1", true},
		{"::ffff:127.0.0.1", true}, {"::ffff:10.0.0.1", true},
		{"::ffff:198.18.0.1", true}, {"::ffff:192.0.2.1", true},
		{"::ffff:198.51.100.1", true}, {"::ffff:203.0.113.1", true},
		{"::ffff:8.8.8.8", false},
