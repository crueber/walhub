...
func Routes(e *Env) []Route {
	...
	return []Route{
		...
		{Method: "GET", Sub: "/api/v1/owners/detailed", Template: "/api/v1/owners/detailed", Handler: h.ownersDetailed, Auth: AuthRead, Expose: true, NonRepo: true},
		{Method: "GET", Sub: "/api-browser/v1/owners/detailed", Handler: h.ownersDetailed, Auth: AuthRead, NonRepo: true},
		{Method: "GET", Sub: "/services/api/owners/detailed", Handler: h.ownersDetailed, Auth: AuthRead, NonRepo: true},
		...
		{Method: "GET", Sub: "/api/v1/owners/{owner}/profile", Template: "/api/v1/owners/{owner}/profile", Handler: h.ownerProfileGet, Auth: AuthRead, Expose: true, NonRepo: true},
		{Method: "GET", Sub: "/api-browser/v1/owners/{owner}/profile", Handler: h.ownerProfileGet, Auth: AuthRead, NonRepo: true},
		{Method: "GET", Sub: "/services/api/owners/{owner}/profile", Handler: h.ownerProfileGet, Auth: AuthRead, NonRepo: true},
		{Method: "PUT", Sub: "/api/v1/owners/{owner}/profile", Handler: h.ownerProfilePut, Auth: AuthWrite, NonRepo: true},
		{Method: "PUT", Sub: "/api-browser/v1/owners/{owner}/profile", Handler: h.ownerProfilePut, Auth: AuthWrite, NonRepo: true},
		{Method: "PUT", Sub: "/services/api/owners/{owner}/profile", Handler: h.ownerProfilePut, Auth: AuthWrite, NonRepo: true},
