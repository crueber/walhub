...
| Overwritable-object list: `manifest.pb`, `bundles/list.pb`, `leases/*`, `maintain/<host>.pb`, `events/cursor(s)/…`, `policy.json`, `fsck.pb`, render cache | P2 | Everything else is `Create`-only, forever |
